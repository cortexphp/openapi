...
it('registers every component bucket', function (): void {
    $components = Components::create()
        ...
        ->example('UserExample', Example::create()->value(['id' => '1']))
        ...
        ->callback('WebhookReceived', Callback::create()->expression('{$request.body#/url}', PathItem::create('/x')->operations(Operation::post())))
        ->pathItem('UserById', PathItem::create('/users/{id}')->summary('User by id'));

    expect($components->toArray())->toBe([
        'schemas' => ['User' => ['type' => 'object']],
        'responses' => ['NotFound' => ['description' => 'Not Found']],
        'parameters' => ['PageSize' => ['name' => 'size', 'in' => 'query', 'schema' => ['type' => 'integer']]],
        'examples' => ['UserExample' => ['value' => ['id' => '1']]],
        'requestBodies' => ['CreateUser' => ['content' => ['application/json' => ['schema' => ['type' => 'string']]]]],
        'headers' => ['X-RateLimit' => ['schema' => ['type' => 'integer']]],
        'securitySchemes' => ['ApiKey' => ['type' => 'apiKey', 'name' => 'X-API-Key', 'in' => 'header']],
        'links' => ['UserLink' => ['operationId' => 'users.show']],
        'callbacks' => ['WebhookReceived' => ['{$request.body#/url}' => ['post' => []]]],
        'pathItems' => ['UserById' => ['summary' => 'User by id']],
    ]);
});
...
it('accepts a Reference in every bucket', function (): void {
    ...
    expect($components->toArray())->toBe([
        'schemas' => ['User' => ['$ref' => '#/components/schemas/UserV1']],
        'responses' => ['NotFound' => ['$ref' => '#/components/responses/NotFoundV1']],
    ]);
});
